...
class Solver(object):
    ...
    def check_accuracy_for_saccarde(self, X, y, num_samples=None, batch_size=546):
        """
        Check accuracy of the model on the provided data.
        ...
        count = y_pred.shape[0]//546
        y_pred2 = []
        for i in range(count):
            y_pred2.append(1 if np.mean(y_pred[i*546:i*546+546])>0.5 else 0)
